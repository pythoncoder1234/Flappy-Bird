...
class Beam:
    ...
    def update(self):
        ...
        if self.x - self.player.x > 0:
            ...
            pygame.draw.rect(self.screen, black,  #Line split!                                               # Bottom vertical rectangle outline
                             (self.x - self.player.x - 1, self.height + 224, 52, 702 - (self.height + 149)))
            pygame.draw.rect(self.screen, green,  #Line split!                                               # Bottom vertical rectangle
